    ...
    <CardHeader className="p-3 pb-1">
      ...
      <div className="mb-2">
        {pass.image_url ? (
          <div className="relative w-full h-32 rounded-lg overflow-hidden">
            <Image
              ...
              onError={(e) => {
                ...
                if (parent) {
                  parent.innerHTML = `
                    <div class="flex items-center justify-center w-full h-40 rounded-lg bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600">
          ...
          <div className="flex items-center justify-center w-full h-32 rounded-lg bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600">
